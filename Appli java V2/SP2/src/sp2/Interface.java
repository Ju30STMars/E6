...
public class Interface extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        listProd = new javax.swing.JComboBox<String>();
        ...
        jLabel1.setText("Sélection du client :");
        ...
        cheminXML.setText("D:\\aa\\");
            ...
            jLabel3.setText("Création fichier XML");

            jLabel4.setText("Envoie des commandes");

            jLabel5.setText("Edition des commandes");
            ...
            layout.setVerticalGroup(
                ...
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(verif, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)))
            );
...
"ORDER BY com.IdCommande"       );     
    ...
    private void majListeCommande(){
        ...
        try{
                ...
                //on execute une requete SELECT
                ResultSet resuCom = statement.executeQuery( "SELECT Co.IdCommande, Cl.NomClient FROM commande Co, Client Cl WHERE Co.DateEnvoie LIKE \"0000-00-00 00:00:00\" AND Cl.IdClient=Co.IdClient" );
                while(resuCom.next())
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        if(cde != ""){
            try{
                    ...
                    //on execute une requete UPDATE
                    statement.executeUpdate( "UPDATE commande SET DateEnvoie=NOW() WHERE IdCommande="+cde );
