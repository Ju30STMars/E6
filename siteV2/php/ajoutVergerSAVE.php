...
<?php
   ...
   if(empty($_SESSION['id'])){
	...
	$sqlInsert="INSERT INTO verger VALUES (DEFAULT,?,?,?,?,?,?,?)";


	$prepareInsert=mysqli_prepare($link,$sqlInsert);
	mysqli_stmt_bind_param($prepareInsert,'sssssss',$_POST['NomVerger'],$_POST['SuperficieVerger'],$_POST['arbre'],$_POST['hectar'],$_GET['prod'],$_POST['com'],$_POST['var']);
...
window.setTimeout("document.form.time.value='0';location=('./ajoutVerger.php');",4000)
</script>
